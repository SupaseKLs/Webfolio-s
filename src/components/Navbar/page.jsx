            ...
            <nav className='text-white h-24'>
                <div className="max-w-screen-lg mx-auto">
                    <div className='h-24 hidden md:flex justify-between items-center md:px-10 uppercase text-xl'>
                        ...
                        <ul className='flex'>
                            <li><Link className='mx-4' href="/" />About</li>
                    ...
                    open && (
                        <motion.div
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <motion.div variants={containerVars} initial="initial" animate="open" exit="initial" className='flex flex-col h-full justify-center items-center '>
                                    {
